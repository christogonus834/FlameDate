...
| React Native Expo (~54) for Core framework |
...
Google Drive: https://drive.google.com/drive/folders/1WO-F_GNiTM1XQaisi8htqQtF6k5-nKii
...
Security Measures we might want to Consider
